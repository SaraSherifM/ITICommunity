...
namespace ITICommunity.Controllers
{
    ...
    public class UserWorkExperiencesController : ControllerBase
    {
        ...
        {
            return await _context.UserWorkExperience.ToListAsync();
        }
        ...
        {
            var userWorkExperience = await _context.UserWorkExperience.FindAsync(id);
        ...
        {
            _context.UserWorkExperience.Add(userWorkExperience);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<UserWorkExperience>> DeleteUserWorkExperience(int id)
        {
            ...
            _context.UserWorkExperience.Remove(userWorkExperience);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.UserWorkExperience.Any(e => e.Id == id);
        }
    }
}
